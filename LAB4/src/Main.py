...
def domanda_9():
    ...
    for dataset in datasets.keys():
        h_distortion_list = hierarchical_clustering_distortion_list(datasets[dataset], min_c, weighted)[min_c:max_c]
        k_distortion_list = [kmeans_clustering(datasets[dataset], i, 5, weighted)[2] for i in interval]
