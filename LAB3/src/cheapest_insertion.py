...
def cheapest_insertion(g: GraphFromFile):
    ...
    C.append(j)
    C.append(0)
    # NOTA: non posso calcolare subito il risultato
    # perchè inserendo nodi nel mezzo del cammino certi archi non li considero più!
